...
/*
 * Map the public catalog_ symbols to sqlite-backed implementations within this
 * translation unit. A dispatcher in catalog.c will delegate to these
 * catalog_sqlite_* functions at runtime.
 */
#include "catalog_sqlite_prefix.h"
...
#include "catalog_sqlite_suffix.h"

const CatalogOps catalog_sqlite_ops = {
#define CATALOG_OP(name) .name = catalog_sqlite_ ## name,
#include "catalog_ops.def"
#undef CATALOG_OP
};
